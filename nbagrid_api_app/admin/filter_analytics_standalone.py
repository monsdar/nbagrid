"""Admin views for Filter Analytics functionality"""
...
class FilterAnalyticsAdmin(admin.ModelAdmin):
    """Admin view for Filter Analytics functionality"""
    
    change_list_template = "admin/filter_analytics_changelist.html"
    ...
    def get_urls(self):
        urls = super().get_urls()
        my_urls = [
            path("analytics/", self.analytics_view, name="filter_analytics_view"),
        ]
        return my_urls + urls
    
    def changelist_view(self, request, extra_context=None):
        """Override changelist to show analytics directly"""
