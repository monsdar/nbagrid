...
class TestGameState(TestCase):
    ...
    def test_game_state_initialization_with_values(self):
        ...
        game_state = GameState(attempts_remaining=5, selected_cells=selected_cells, is_finished=True, total_score=1.0)
    ...
    def test_from_dict(self):
        ...
        data: Dict[str, Any] = {
            ...
            "selected_cells": {"0_0": [self.cell_data1], "0_1": [self.cell_data2]},
            "is_finished": True,
            "total_score": 1.0,
        }
