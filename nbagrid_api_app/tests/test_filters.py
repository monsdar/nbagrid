...
class Top10DraftpickFilterTest(TestCase):
    def setUp(self):
        ...
        self.player1 = Player.objects.create(stats_id=1, name="Player 1", draft_number=1, draft_year=2020)  # Top 10 pick
        ...
        self.player4 = Player.objects.create(stats_id=4, name="Player 4", draft_number=5, draft_year=2019)  # Top 10 pick
        self.player5 = Player.objects.create(stats_id=5, name="Player 5", is_undrafted=True)
...
class USAFilterTest(TestCase):
    def setUp(self):
        # Create test players
        self.usa_player1 = Player.objects.create(stats_id=1, name="USA Player 1", country="USA")
        self.usa_player2 = Player.objects.create(stats_id=2, name="USA Player 2", country="USA")
        self.int_player1 = Player.objects.create(stats_id=3, name="International Player 1", country="Canada")
        self.int_player2 = Player.objects.create(stats_id=4, name="International Player 2", country="France")
