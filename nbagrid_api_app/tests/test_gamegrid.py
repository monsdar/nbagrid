...
from nbagrid_api_app.models import GameCompletion, GameFilterDB, GameGrid, GameResult, Player, Team
...
class GameGridModelTest(TestCase):
    ...
    def setUp(self):
        ...
        self.grid = GameGrid.objects.create(
            date=self.test_date,
            grid_size=3,
            cell_correct_players={"0_0": 5, "0_1": 3, "0_2": 7, "1_0": 2, "1_1": 4, "1_2": 6, "2_0": 1, "2_1": 8, "2_2": 9},
        )
    ...
    def test_empty_grid(self):
        ...
        empty_grid = GameGrid.objects.create(date=empty_date, grid_size=3, cell_correct_players={})
