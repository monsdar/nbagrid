...
cpu_limit_gauge = Gauge(
    'pythonanywhere_cpu_limit_seconds',
    'Daily CPU limit in seconds'
)

cpu_usage_gauge = Gauge(
    'pythonanywhere_cpu_usage_seconds',
    'Daily CPU usage in seconds'
)

cpu_usage_percent_gauge = Gauge(
    'pythonanywhere_cpu_usage_percent',
    'Daily CPU usage as percentage of limit'
)

cpu_reset_seconds_gauge = Gauge(
    'pythonanywhere_cpu_reset_seconds',
    'Seconds until CPU usage reset'
)
